...
<section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Customer Order</h2>
                        ...
                        <div class="card m-0 border rounded" >
                          ...
                          <p class="card-text">
                            ...
                            <div class="row">
                                ...
                                <input type="number" class="form-control input-sm count" name="qty" value="{{$data->quantity}}">
                            ...
                            <!-- <a class="m-1 btn btn-warning w-100" href="/konsumen/detail/{{$data->id}}/cart">Keranjang +</a> -->
                            <a class="payment m-1 btn btn-success w-100" 
                            >Bayar</a>

...
<div id="app">
    <div class="main-wrapper container">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <a href="index.html" class="navbar-brand sidebar-gone-hide">Gerabah Kasongan</a>
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li  class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg {{$beep==true?'beep':null}}"><i class="fas fa-cart-plus	"></i></a>
            <div  class="dropdown-menu dropdown-list dropdown-menu-right">
              <div class="dropdown-header">Notifications
                <div class="float-right">
                  <a href="#">Mark All As Read</a>
              ...
              <div style="overflow-y: scroll;" class="dropdown-list-content dropdown-list-icons">
                  @foreach($cust_order_2 as $data)
                    @if($data->notif == '1')
                    <a href="/konsumen/detail/detail-order/{{$data->id_customer_order}}" class="dropdown-item dropdown-item-unread bg-light">
                    ...
                    <div class="dropdown-item-desc">
                        ...
                        <div class="time text-primary">{{$data->note}} <span>({{$data->quantity}})</span></div>
                    </div>
                    </a>
                    @else
                    <a href="/konsumen/detail/detail-order/{{$data->id_customer_order}}" class="dropdown-item dropdown-item-read">
                    <div class="dropdown-item-icon text-white ">
                        <!-- <i class="fas fa-code"></i> -->
                        <img class="card-img-top" src="{{ asset('images/'.$data->image) }}" alt="Card image cap">
                    </div>
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="/konsumen/profile" class="dropdown-item has-icon">

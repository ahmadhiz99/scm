    ...
    <form class="form-inline mr-auto">
        ...
        <div class="search-element">
            ...
            <div class="search-result">
                ...
                <div class="search-item">
                    <a href="#">
                        <img class="mr-3 rounded" width="30" src="../stisla/assets/img/products/product-3-50.png"
                            alt="product">
                ...
                <div class="search-item">
                    <a href="#">
                        <img class="mr-3 rounded" width="30" src="../stisla/assets/img/products/product-2-50.png"
                            alt="product">
                        Drone X2 New Gen-7
                    </a>
                </div>
                <div class="search-item">
                    <a href="#">
                        <img class="mr-3 rounded" width="30" src="../stisla/assets/img/products/product-1-50.png"
                            alt="product">
                        Headphone Blitz
                    </a>
                </div>

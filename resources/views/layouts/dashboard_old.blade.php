    ...
    <div class="main-wrapper">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a class="nav-link" href="/admin/data-pendaftar"><i class="bi bi-people-fill"></i> <span>Data Pendaftar</span></a></li>
              <li><a class="nav-link" href="/admin/data-devcode"><i class="bi bi-person-workspace"></i> <span>Data DevCode</span></a></li>
              <li><a class="nav-link" href="/admin/data-minat"><i class="bi bi-grid"></i> <span>Data Minat</span></a></li>
                    ...
                    <table class="table table-striped mb-0">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <a href="#" class="font-weight-600"><img src="{{asset('stisla')}}/assets/img/avatar/avatar-1.png" alt="avatar" width="30" class="rounded-circle mr-1"> Bagus Dwi Cahya</a>
                          </td>
                          <td>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2022 <div class="bullet"></div> Design By <a href="https://nauval.in/">HAHAHA</a>
        </div>
